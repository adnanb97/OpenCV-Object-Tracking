...
fps = None
file = open("BenchmarkResults/Results"+str(args["video"][10:])+str(args["tracker"])+"METRIKA5HSV.txt", "w")
filefps = open("BenchmarkResults/Results"+str(args["video"][10:])+str(args["tracker"])+"METRIKA5HSVfpssuc.txt","w")
ballLower = (65, 255, 0)
...
while True:
    ...
    if initBB is not None:
       ...
       # cv2.rectangle(frame, (x2, y2), (x2 + w2, y2 + h2), (0, 0, 255), 2)
        ...
        cv2.putText(frame, "Distance: {:.4f}".format(distance), (10, 30),
...
print ("Prosjecna udaljenost za algoritam " + str(args.get("tracker")) + " sa HSV color trackingom je = " + str(totalDistance / brojacFramea)[0:7])
